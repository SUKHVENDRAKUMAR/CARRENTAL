...
SECRET_KEY = 'django-insecure-!sta8idfg-k^^6e&k2!_&56azrrrc3=wuf^oyb2r@orz9@m2d*'
...
# Media files (uploaded user car photos)
MEDIA_URL = '/media/'
...
# Email configurations (default console for local dev, can be configured for SMTP/Gmail)
EMAIL_BACKEND = os.getenv('DJANGO_EMAIL_BACKEND', 'django.core.mail.backends.console.EmailBackend')
EMAIL_HOST = os.getenv('DJANGO_EMAIL_HOST', 'smtp.gmail.com')
EMAIL_PORT = int(os.getenv('DJANGO_EMAIL_PORT', '587'))
EMAIL_USE_TLS = os.getenv('DJANGO_EMAIL_USE_TLS', 'True').lower() == 'true'
EMAIL_HOST_USER = os.getenv('DJANGO_EMAIL_HOST_USER', '')
EMAIL_HOST_PASSWORD = os.getenv('DJANGO_EMAIL_HOST_PASSWORD', '').replace(' ', '')
